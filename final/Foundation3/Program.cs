class Program
{
    static void Main(string[] args)
    {
        ...
        Lectures lectures = new Lectures("Alvin Meridith", "1300\u03C0/3", "Calculus", "Calc 1", "2-31-28", "12:57", "Lecture", lectureAddress);

        Receptions receptions = new Receptions("RSVP@email", "Welders unite", "Welders come together", "13-31-27", "13:65", "Reception", receptionsAddress);

        Outdoor outdoor = new Outdoor(true, "Tornado watchers", "Watch tornados together", "4-9-26", "00:00", "Outdoor", outdoorAddress);
